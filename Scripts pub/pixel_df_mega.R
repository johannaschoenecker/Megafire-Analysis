...
yrs_ids <- fread(paste0(here(),"/Data/SN_megafires_1985_2023.csv"))
yrs_ids$year <- yrs_ids$YEAR_



# Loading all the other rasters, which every fire should have
elev_raster <- raster(paste0(here(),"/Data/elevation.tif"))
aspect_raster <- raster(paste0(here(),"/Data/aspect.tif"))
slope_raster <- raster(paste0(here(),"/Data/slope.tif"))
tpi_raster <- raster(paste0(here(),"/Data/tpi.tif"))
tri_raster <- raster(paste0(here(),"/Data/tri.tif"))
...
for (f in filtered_files) {
  ...
  prism_fire_year <- stack(paste0(here(),"/Data/Rasters/3310_PRISM_anomalies/prism_anomaly_",i,".tif"))
  prism_1pre <-stack(paste0(here(),"/Data/Rasters/3310_PRISM_anomalies/prism_anomaly_",g,".tif"))
  prism_1post <-stack(paste0(here(),"/Data/Rasters/3310_PRISM_anomalies/prism_anomaly_",o,".tif"))
  prism_fire_year_abs <-stack(paste0(here(),"/Data/Rasters/3310_PRISM_abs/prism_annual_",i,".tif"))
  prism_1pre_abs <- stack(paste0(here(),"/Data/Rasters/3310_PRISM_abs/prism_annual_",g,".tif"))
  prism_1post_abs <- stack(paste0(here(),"/Data/Rasters/3310_PRISM_abs/prism_annual_",o,".tif"))
  

  last_fire_raster <- raster(paste0(here(),"/Data/Rasters/SN_fires_yearly_rasters/fires_up_to_",i,".tif"))
  
  veg_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", g,"_Mega_",k, ".tif")
  veg_1post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", o,"_Mega_",k,  ".tif")
  veg_2post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/",m,"_Mega_",k,  ".tif")
  veg_3post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m2,"_Mega_",k,  ".tif")
  veg_4post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m3,"_Mega_",k,  ".tif")
  veg_5post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m4,"_Mega_",k,  ".tif")
  veg_6post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m5,"_Mega_",k,  ".tif")
  veg_7post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/",m6,"_Mega_",k,  ".tif")
  veg_8post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/",m7,"_Mega_",k,  ".tif")
  veg_9post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m8,"_Mega_",k,  ".tif")
  veg_10post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m9,"_Mega_",k,  ".tif")
  veg_11post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m10,"_Mega_",k,  ".tif")
  veg_12post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m11,"_Mega_",k,  ".tif")
  veg_13post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m12,"_Mega_",k,  ".tif")
  veg_14post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m13,"_Mega_",k,  ".tif")
  veg_15post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m14,"_Mega_",k,  ".tif")
  veg_16post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m15,"_Mega_",k,  ".tif")
  veg_17post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m16,"_Mega_",k,  ".tif")
  veg_18post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m17,"_Mega_",k,  ".tif")
  veg_19post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m18,"_Mega_",k,  ".tif")
  veg_20post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m19,"_Mega_",k,  ".tif")
  veg_21post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m20,"_Mega_",k,  ".tif")
  veg_22post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m21,"_Mega_",k,  ".tif")
  veg_23post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m22,"_Mega_",k,  ".tif")
  veg_24post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m23,"_Mega_",k,  ".tif")
  veg_25post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m24,"_Mega_",k,  ".tif")
  veg_26post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m25,"_Mega_",k,  ".tif")
  veg_27post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m26,"_Mega_",k,  ".tif")
  veg_28post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m27,"_Mega_",k,  ".tif")
  veg_29post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m28,"_Mega_",k,  ".tif")
  veg_30post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m29,"_Mega_",k,  ".tif")
  veg_31post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m30,"_Mega_",k,  ".tif")
  veg_32post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m31,"_Mega_",k,  ".tif")
  veg_33post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m32,"_Mega_",k,  ".tif")
  veg_34post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m33,"_Mega_",k,  ".tif")
  veg_35post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m34,"_Mega_",k,  ".tif")
  veg_36post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m35,"_Mega_",k,  ".tif")
  veg_37post_filename <- paste0(here(),"/Data/Rasters/veg_annual_individual/",k,"/", m36,"_Mega_",k,  ".tif")
  ...
  raster_name<- paste0(here(),"/Data/Rasters/RdNBR_classified/",f)
  ...
  fwrite(master_raster,paste0(here(),"/Data/raster_df_mega/",k,'.csv'), row.names = FALSE)
  }
...
# Directories
csv_directory <- paste0(here(),"/Data/raster_df_mega/")
