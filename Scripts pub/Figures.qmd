...
#### Save all combinations to folder

ggsave(
  filename  = paste0(here(),"/Figures/plot_1a.emf"),
  plot      = plot_1a,
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_1a.pdf"),
  plot     = plot_1a,
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_1b.emf"),
  plot      = plot_1b,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_1b.pdf"),
  plot     = plot_1b,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_2a.emf"),
  plot      = figure_2a,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_2a.pdf"),
  plot     = figure_2a,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_S3.emf"),
  plot      = figure_S3,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_S3.pdf"),
  plot     = figure_S3,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
plot_core_area <- ggplot2::ggplot(
  ...
  ggplot2::labs(x = "Patch size class", y = "Core area \nw/in patch (ha)") +
...
lineplot_core_area <- ggplot2::ggplot(
  ...
  ggplot2::labs(y = "Mean core area w/in patch (ha)", x = "Fire year") +
  line_theme
...
# Decrease x-axis label text
plot_paratio <- plot_paratio +
  theme(axis.text.x = element_text(size = 8))

plot_contiguity <- plot_contiguity +
  theme(axis.text.x = element_text(size = 8))

plot_core_area <- plot_core_area +
  theme(axis.text.x = element_text(size = 8))

# Make plots more square
plot_paratio    <- plot_paratio    + theme(aspect.ratio = 0.8)
plot_contiguity <- plot_contiguity + theme(aspect.ratio = 0.8)
plot_core_area  <- plot_core_area  + theme(aspect.ratio = 0.8)


all_levels <- c("small", "medium", "large", "very large")  # whatever your bins are

paratio_burned$n_bins        <- factor(paratio_burned$n_bins,        levels = all_levels)
contiguity_burned$n_bins     <- factor(contiguity_burned$n_bins,     levels = all_levels)
core_area_burned$n_bins    <- factor(core_area_burned$n_bins,    levels = all_levels)

sx <- ggplot2::scale_x_discrete(drop = FALSE)

plot_paratio    <- plot_paratio    + sx
plot_contiguity <- plot_contiguity + sx
plot_core_area  <- plot_core_area  + sx
...
# Save only patch metrics plots
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_3.emf"),
  plot      = top_labeled,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_3.pdf"),
  plot     = top_labeled,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_3c.pdf"),
  plot     = plot_core_area,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
plot_4a_legend <- ggplot(df_stacked) +
  geom_rect(
    aes(
      xmin = as.numeric(factor(rdnbr_class)) - 0.4,
      xmax = as.numeric(factor(rdnbr_class)) + 0.4,
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_4a_legend.emf"),
  plot      = plot_4a_legend,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_4a_legend.pdf"),
  plot     = plot_4a_legend,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_4b.emf"),
  plot      = plot_4b,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_4b.pdf"),
  plot     = plot_4b,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
plot_S6 <- ggplot(veg_counts_master, aes(x = rdnbr, fill = RF_pre_veg)) +
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_S6.emf"),
  plot      = plot_S6,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_S6.pdf"),
  plot     = plot_S6,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
scatter_noreturn <- ggplot(class_counts_noreturn, aes(x = fire_year, y = count)) +
  geom_point(size = 3, alpha = 0.8, color = "black") +  # Scatter plot
  geom_smooth(method = "gam", formula = y ~ s(x), color = "black", se = TRUE) +  # ← GAM here
  labs(
    title = "",
    x = "Fire year",
    y = "Coniferous burned area not recovered within 20 years (ha)"
  ) +
  scale_y_continuous(
    limits = c(0, 150000),
    labels = comma               # ← thousand separators!
  ) +
  theme_classic() +
  theme(
    text = element_text(size = 12),
...
# Write plots to file
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_6b.emf"),
  plot      = scatter_noreturn,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
  limitsize = FALSE
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_6b.pdf"),
  plot     = scatter_noreturn,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
# Barplot only, no cumulative curves
library(ggplot2)
library(scales)

# Compute a small negative offset to place labels below zero
y_offset <- -0.05 * max(class_counts$area, na.rm = TRUE)

bars_recovered <- ggplot(
  class_counts,
  aes(x = fire_year, y = area,
      fill = factor(returned), alpha = type)
) +
  geom_bar(stat = "identity", position = "dodge") +

  # --- Add segment for OBSERVED ---
  annotate("segment",
           x = 1985, xend = 2002.5,
  ...
  annotate("text",
           x = (1985 + 2002.5) / 2,
           y = y_offset - 0.02 * max(class_counts$area),
           label = "observed",
           size = 4) +

  # --- Add segment for PREDICTED ---
  annotate("segment",
           x = 2003, xend = 2023,
           y = y_offset, yend = y_offset,
           size = 1) +
  ...
  scale_fill_manual(
    values = c("0" = "#737373", "1" = "#2D7A2D"),
    labels = c("not recovered", "recovered"),
    name   = "20-year recovery status"
  ) +
  scale_alpha_manual(
    values = c(measured = 1, predicted = 0.7),
    guide  = "none"
  ) +

  # Y-axis: bars start exactly at 0
  scale_y_continuous(
    expand = c(0, 0),
    labels = comma,
    name   = "High-severity coniferous area (ha)",
    limits = c(y_offset - 0.05 * max(class_counts$area), NA)
  ) +
...
bars_recovered <- bars_recovered +
  theme(
    legend.position   = c(0.02, 0.98),        # top-left inside plot
    legend.justification = c(0, 1),           # align top-left corner of legend
...
# Write plots to file
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_6.emf"),
  plot      = bars_recovered,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_6.pdf"),
  plot     = bars_recovered,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_2b.emf"),
  plot      = plot_2b,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_2b.pdf"),
  plot     = plot_2b,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_2c.emf"),
  plot      = plot_2c,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_2c.pdf"),
  plot     = plot_2c,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
# Same plot, including a legend
plot_none <- ggplot(marginal_data, 
                    aes(x = patch_size_class, 
                        y = total_abs_notRecov_thousand_ha, 
                        fill = factor(rdnbr_class))) +
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/plot_4c.emf"),
  plot      = plot_3,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 3, units = "in",
  bg        = "white",
  limitsize = FALSE
)
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/plot_4c.pdf"),
  plot     = plot_3,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 3, units = "in",
  bg       = "white",
...
all_pixels <- all_pixels[!is.na(patch_size_class) & !is.na(rdnbr_class.x) & rdnbr_class.x > 0]
...
# Summarize area not recovered within 20 years
marginal_data <- plot_data %>%
  group_by(patch_size_class, rdnbr_class.x) %>%
  summarise(
    total_abs_notRecov = sum(abs_not_recovered, na.rm = TRUE),
    .groups = "drop"
  ) %>%
...
# Plot
plot_none <- ggplot(marginal_data, aes(x = patch_size_class, y = total_abs_notRecov_thousand_ha, fill = factor(rdnbr_class.x))) +
...
p <- ggplot(veg_long, aes(x = rel_year, y = count, fill = veg_class)) +
  ...
  # --- add vertical red line + label ---
  geom_vline(xintercept = 0.5, color = "red", linewidth = 1) +
  annotate("text", x = 0.5, y = max(veg_long$count)*1.10,
           label = "fire", color = "red", angle = 90, vjust = -0.5,
           size = 4.5) +
  # -------------------------------------

  scale_fill_manual(
    values = veg_colors_ordered,
    labels = veg_labels,
    drop = FALSE,
    na.translate = FALSE
  ) +
...
ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/Patches/",fire_id, "_patch", patch_id, ".emf"),
  plot      = p,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
  width     = 8.27, height = 4.5, units = "in",
  bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/Patches/",fire_id, "_patch", patch_id, ".pdf"),
  plot     = p,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
for (i in 1:nrow(patch_summary_df)) {
  ...
  veg_spatial <- df_patch %>%
    dplyr::select(x, y, starts_with("RF_post"), RF_pre_veg) %>%
...
p <- ggplot(veg_spatial, aes(x = x, y = y, fill = veg_class)) +
  ...
  coord_equal() +
  facet_wrap(~ rel_year, ncol = 11) +   # <-- fixed number of columns
  labs(
    title = paste("Vegetation over time\nFire", fire_id, "Patch", patch_id),
  ...
  theme(
    ...
    axis.title  = element_blank(),     # (belt-and-braces: also kill any axis titles)
    panel.grid  = element_blank(),
     panel.background = element_rect(fill = "white", colour = "grey"),
  panel.border     = element_rect(fill = NA, colour = "grey", size = 0.5),
...
#   ggsave(
#   filename  = paste0(here(),"/Figures/Poster BES/Patches veg maps/",fire_id, "_patch", patch_id, ".emf"),
#   plot      = p,
#   device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Arial", ...),
#   width     = 8.27, height = 4.5, units = "in",
#   bg        = "white",
...
ggsave(
  filename = paste0(here(),"/Figures/Poster BES/Patches veg maps/",fire_id, "_patch", patch_id, ".pdf"),
  plot     = p,
  device   = cairo_pdf,        # vector PDF with good font support
  width    = 8.27, height = 4.5, units = "in",
  bg       = "white",
...
print(final_plot)
  ...
  ggsave(
  filename  = paste0(here(),"/Figures/Poster BES/patch_examples.emf"),
  plot      = final_plot,
  device    = function(filename, ...) devEMF::emf(filename, emfPlus = TRUE, family = "Calibri", ...),
  width     = 8.27, height = 2.5, units = "in",
  bg        = "white",
  limitsize = FALSE
)
...
for (i in 1:nrow(patch_summary_df)) {
  ...
  fire_patch_map <- ggplot(df, aes(x = x, y = y)) +
    geom_point(color = "grey80", size = 0.4) +
    geom_point(data = df[id == patch_id], color = "black", size = 0.4) +
    coord_fixed() +
    theme_void() +
    labs(title = "") +
    annotation_scale(
  ...
  # Save one map per patch
  out_base <- paste0(here(), "/Figures/Poster BES/Fire patch maps/fire", fire_id, "_patch", patch_id)
